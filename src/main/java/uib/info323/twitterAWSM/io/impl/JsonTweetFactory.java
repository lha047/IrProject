...
public class JsonTweetFactory implements TweetFactoryIntf{
	...
	public ITweetSearchResults searchTweets(String searchTerm) {
		...
		LinkedList<ITweetInfo323> tweets = jsonToTweets(object.get("results"), parser);

		// Create an object for results and return this object
		return new TweetSearchResults(searchTerms, nextPageUrl, refreshUrl, tweets, pageNumber);
	...
	private LinkedList<ITweetInfo323> jsonToTweets(JsonElement jsonTweets, JsonParser parser) {
